<template>
  <div class="h-full flex items-center justify-center">
    <div class="text-center max-w-md">
      ...
      <!-- 评审状态下显示取消按钮 -->
      <button
        v-if="status === 'evaluating'"
        @click="emit('cancel-evaluation')"
        class="mt-4 px-4 py-2 text-sm text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-colors"
      >
        取消评审
      </button>
    </div>
