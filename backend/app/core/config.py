...
class Settings(BaseSettings):
    ...
    writer_min_words: int = Field(
        default=2000,
        ge=500,
        env="WRITER_MIN_WORDS",
        description="章节生成最小字数",
    )
    writer_max_words: int = Field(
        default=2500,
        ge=1000,
        env="WRITER_MAX_WORDS",
    ...
    # -------------------- 目录配置 --------------------
    prompts_dir: Optional[str] = Field(default=None, env="PROMPTS_DIR", description="提示词目录路径")
